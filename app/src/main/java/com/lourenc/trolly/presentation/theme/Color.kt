...
val WhiteCards = Color(0xFFF8F8F8)
val SandBackground = Color(0xFFFAFAFA)
val TextDark = Color(0xFF111111)
val TextLight = Color(0xFFFFFFFF)
val Error = Color(0xFFE74C3C)

val CoralPrimaryDark = CoralPrimary
val CoralVariantDark = CoralVariant
...
val CompleteGreen = Color(0xFF4CAF50)
val EditBlueDark = EditBlue
val CompleteGreenDark = CompleteGreen
